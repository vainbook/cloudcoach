  ...
  items: [
    ...
    { tab: 'book', id: 'book-films', no: 'F', t: '推薦電影', sub: '8 部和愛情有關的電影', src: '',
      ...
      list: [
        ...
        { id: 'film-02', t: '真愛每一天', sub: 'About Time・2013',
        ...
        { id: 'film-04', t: '我們的愛情一言難盡', sub: 'Newness・2017',
          body: '兩個在交友軟體上相遇的年輕人，很快走進關係，又試著用開放的方式維持新鮮感。親密不能靠不斷追求新的刺激，而是要願意面對彼此的不安，好好溝通。' },
