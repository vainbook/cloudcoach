...
window.UC_LIBRARY = {
  ...
  items: [
    /* 必修 */
    { tab: 'req', id: 'req-01', no: '01', t: '戀愛三步驟', dims: ['values'], sub: '邂逅吸引 → 走入心房 → 親密關係', len: '4 章', src: '', cover: 'assets/course-covers/03-chat-abstract-v1.webp' },
    { tab: 'req', id: 'req-02', no: '02', t: '信念系統', dims: ['values'], sub: '信念 → 行為 → 結果', len: '4 章', src: '', cover: 'assets/course-covers/01-awareness-abstract-color-v3.webp' },
    { tab: 'req', id: 'req-03', no: '03', t: '負責任版本', dims: ['flirt'], sub: '受害者 → 負責任', len: '5 章', src: '', cover: 'assets/course-covers/03-responsible-version-dark-v1.webp' },
    /* ⚠️ 從選修搬到必修，但 id 保持 opt-06 —— 換 id 等於換一堂課，連結會接錯。 */
    { tab: 'req', id: 'opt-06', no: '04', t: '感情價值觀｜三門', dims: ['values'], sub: '認識吸引・經營關係・終身伴侶', len: '3 章', src: '', cover: 'assets/course-covers/06-relationship-values-doors-abstract-v1.webp' },

    /* 選修 */
    { tab: 'opt', id: 'opt-05', no: '05', t: '說故事技巧', dims: ['values','emo'], sub: '故事模版與畫故事', len: '4 章', src: '', cover: 'assets/course-covers/05-storytelling-coffee-abstract-v1.webp' },
    { tab: 'opt', id: 'opt-13', no: '06', t: '網聊救台灣', dims: ['flirt','circle'], sub: '學員實際對話診斷', len: '5 章', src: '', cover: 'assets/course-covers/13-online-chat-phone-abstract-v1.webp' },
    /* 冷讀拆成三階，三張封面先共用同一張（使用者指定）。 */
    { tab: 'opt', id: 'opt-04', no: '07', t: '冷讀聊天｜入門', dims: ['flirt','emo'], sub: '不是要讀得準，是更容易切入', len: '3 章', src: '', cover: 'assets/course-covers/04-cold-reading-abstract-v1.webp' },
    { tab: 'opt', id: 'opt-16', no: '08', t: '冷讀聊天｜進階', dims: ['flirt','emo'], sub: '內容待補', len: '待補', src: '', cover: 'assets/course-covers/04-cold-reading-abstract-v1.webp' },
    { tab: 'opt', id: 'opt-17', no: '09', t: '冷讀聊天｜高階', dims: ['flirt','emo'], sub: '內容待補', len: '待補', src: '', cover: 'assets/course-covers/04-cold-reading-abstract-v1.webp' },
